...
<div class="col-md-6">
   ...
   <input type="text" name="youtube" placeholder="Url Youtube" value="<?php echo $site->youtube ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Youtube <i class="fa fa-youtube"></i></label>
    <input type="text" name="nama_youtube" placeholder="Nama Youtube" value="<?php echo $site->nama_youtube ?>" class="form-control">
    </div>
